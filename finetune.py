...
parser.add_argument('--task', type=str, default='classification', help='[classification, regression, interpolation]')
parser.add_argument('--pooling', type=str, default='bert', help='[ave, att, bert]')
parser.add_argument('--pretrain_model', type=str, default='0.15', help='[full, full2, cl, interp, att, bert, 0.15]')
parser.add_argument('--path', type=str, default='/home/ranak/iasmts_data/', help='base path where all datasets are located')
parser.add_argument('--finetune_samples', type=str, default='train', help='[train, 1, 2, 4, 8, 16, 32]')
parser.add_argument('--num_versions', type=int, default=1, help='[1, 2, 3, 4, 5]')
...
if __name__ == '__main__':
    ...
    for version in range(args.num_versions):
        ...
        data_obj = utils.get_finetune_data(args, version)
        ...
        if args.pretrain_model is not None:
            ...
            model.bert.load_state_dict(torch.load('models/pretrained_new/' + 
                args.dataset + '_' + args.pretrain_model + '.h5')['model_state_dict'])
        ...
        for itr in range(1, args.niters + 1):
            ...
            if itr % 100 == 0 and args.save:
                torch.save({
                    ...
                    'loss': -loss,
                }, 'models/finetuned_new/' + args.dataset + '_' + args.pretrain_model + '_' + args.task + '_' + args.finetune_samples + '_v' + str(version) + 
                    '.h5')
        ...
        results_path = 'results/finetuned_new/' + args.dataset + '_' + args.pretrain_model + '_' + args.task + '_' + args.finetune_samples + '_v' + str(version) + '.npy'
