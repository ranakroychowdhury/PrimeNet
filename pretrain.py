...
parser.add_argument('--pretrain_tasks', type=str, default='full2', help='[full, cl, interp, full2]')
...
if __name__ == '__main__':
    ...
    expt_name = args.dataset + '_' + str(args.pooling) + '_' + str(args.segment_num) + '_' + str(args.mask_ratio_per_seg)
    ...
    for itr in range(1, args.niters + 1):
        ...
        if args.pretrain_tasks == 'full' or args.pretrain_tasks == 'cl' or args.pretrain_tasks == 'full2':
            if val_acc > best_acc:
                ...
                }, 'models/pretrained_new/' + expt_name +
                    '.h5')
    ...
    results_path = 'results/pretrained_new/' + expt_name + '.npy'
