...
class CLDataCollator:
    ...
    def __call__(self, batch):
        ...
        if self.args.pretrain_tasks == 'full2':
        ...
        return {'value': value_batch, 'time': time_batch, 'mask': mask_batch}
    ...
    def _constant_length_sampling(self, mask):
        ...
        if self.args.mask_ratio_per_seg * count_ones < 1: seg_seq_len = 1
        else: seg_seq_len = int(self.args.mask_ratio_per_seg * count_ones)
